...
type FakeStore struct {
	...
	CreateInstanceDetailsStub        func(id string, details csibroker.ServiceInstance) error
	createInstanceDetailsMutex       sync.RWMutex
	createInstanceDetailsArgsForCall []struct {
		id      string
		details csibroker.ServiceInstance
	}
	...
	IsInstanceConflictStub        func(id string, details csibroker.ServiceInstance) bool
...
func (fake *FakeStore) RetrieveInstanceDetails(id string) (csibroker.ServiceInstance, error) {
...
func (fake *FakeStore) RetrieveInstanceDetailsReturns(result1 csibroker.ServiceInstance, result2 error) {
...
func (fake *FakeStore) CreateInstanceDetails(id string, details csibroker.ServiceInstance) error {
...
func (fake *FakeStore) CreateInstanceDetailsArgsForCall(i int) (string, csibroker.ServiceInstance) {
	fake.createInstanceDetailsMutex.RLock()
	defer fake.createInstanceDetailsMutex.RUnlock()
...
func (fake *FakeStore) IsInstanceConflict(id string, details csibroker.ServiceInstance) bool {
...
func (fake *FakeStore) IsInstanceConflictArgsForCall(i int) (string, csibroker.ServiceInstance) {
	fake.isInstanceConflictMutex.RLock()
	defer fake.isInstanceConflictMutex.RUnlock()
...
var _ csibroker.Store = new(FakeStore)
